...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double driveKS = .2479; //0.32; //TODO: This must be tuned to specific robot
        public static final double driveKV =  6.9836; //1.51;
        public static final double driveKA = 1.4986; //0.27;
        ...
        public static final class Mod0 { //TODO: This must be tuned to specific robot
            ...
            public static final int angleMotorID = 11; //11
            public static final int DutyCycleEncoderID = 15; //0
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(324);
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, DutyCycleEncoderID, angleOffset);
        }

        /* Front Right Module - Module 1 */
        public static final class Mod1 { //TODO: This must be tuned to specific robot
            public static final int driveMotorID = 2; //2
            public static final int angleMotorID = 12; //12
            public static final int DutyCycleEncoderID = 13; //1 
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(40);
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, DutyCycleEncoderID, angleOffset);
        }
        ...
        public static final class Mod2 { //TODO: This must be tuned to specific robot
            ...
            public static final int DutyCycleEncoderID = 20; //2
        ...
        public static final class Mod3 { //TODO: This must be tuned to specific robot
            public static final int driveMotorID = 4; //4
            public static final int angleMotorID = 14; //14
            public static final int DutyCycleEncoderID = 17; //3
