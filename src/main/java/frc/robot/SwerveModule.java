...
public class SwerveModule {
    ...
    public Rotation2d getDutycoder(){
    ...
    public void resetToAbsolute(){
        //double absolutePosition = getDutycoder().getDegrees() - angleOffset.getDegrees();
        double absolutePosition = getDutycoder().getRotations() - angleOffset.getRotations();
